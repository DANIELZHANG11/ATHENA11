...
const interFont = createFont({
  family:
    'Inter, "Noto Sans SC", -apple-system, BlinkMacSystemFont, "SF Pro Text", "SF Pro Display", sans-serif',
  size: {
    1: 12, // caption
    2: 13, // footnote
    3: 15, // subhead
...
const lightTheme = {
  ...
  // 添加 outlineColor 以消除警告
  outlineColor: tokens.color.systemBlue,
};
...
const darkTheme = {
  ...
  // 添加 outlineColor 以消除警告
  outlineColor: darkColors.systemBlue,
};
